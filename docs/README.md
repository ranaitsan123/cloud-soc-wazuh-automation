# Cloud SOC Documentation Hub

Welcome to the consolidated documentation for the Cloud SOC Wazuh Automation project.

This repository contains architecture, deployment, automation, and troubleshooting guidance for the project.

## Documentation Sections

- **1. Getting Started** — Quick setup, installation, and initial commands
  - `docs/1-getting-started/README.md`
  - `docs/1-getting-started/01-installation.md`
...
- **3. Reference** — Technical reference and architecture details
  ...
  - `docs/3-reference/terraform/README.md`

- **4. Explanation** — Design decisions, migration guidance, and scenarios
  - `docs/4-explanation/README.md`
  - `docs/4-explanation/python-migration-guide.md`

- **Troubleshooting** — Common issues, cleanup, and recovery guidance
...
Some older documentation files have been moved into the archive folder while the new structure becomes the default reference.
